...
- [[#python][Python]]
  ...
  - [[#debugging][Debugging]]
- [[#auctex-settings][Auctex settings]]
  - [[#remember-to-set-dir-localsel-file-for-example][Remember to set .dir-locals.el file. For example]]
  - [[#disable-pretty-symbols][Disable pretty symbols]]
  - [[#support-for-multi-document-latex-projects][Support for multi document latex projects]]
  - [[#to-use-pdf-tools-instead-of-okular][To use pdf-tools instead of okular]]
  - [[#reftex-to-ref-chpaters-sections-figures-etc][Reftex to \ref chpaters, sections, figures etc..]]
  - [[#asynchronous-latex-fragment-generation][Asynchronous latex fragment generation]]
...
* Auctex settings
** Remember to set .dir-locals.el file. For example
#+begin_comment
((latex-mode
  (TeX-master . "/home/vasu/work_strand/PhD_thesis/20240805/main.tex")
  (reftex-default-bibliography . ("/home/vasu/work_strand/PhD_thesis/20240805/bibliography.bib"))))
#+end_comment
...
** Support for multi document latex projects
...
** To use pdf-tools instead of okular
#+begin_src elisp
...
** Reftex to \ref chpaters, sections, figures etc..
#+begin_src elisp
...
** Asynchronous latex fragment generation
#+begin_src elisp
