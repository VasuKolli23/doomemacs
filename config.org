...
- [[#permamently-display-workspaces-minibuffer][Permamently display workspaces minibuffer]]
...
* Permamently display workspaces minibuffer
#+begin_src elisp
(after! persp-mode
...
* TODO
+ In lsdyna and abaqus mode - cursor goes to the end after save.
